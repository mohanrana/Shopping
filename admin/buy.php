...
<div class="container">
    ...
    <tr>
      <td height="24" bgcolor="#333333"><div align="center" class="style5 style7">Item Name</div></td>
      <td width="239" bgcolor="#333333"><div align="center" class="style8">Quantity</div></td>
      <td width="164" bgcolor="#333333"><div align="center" class="style8">Date</div></td>
     <td width="167" bgcolor="#333333"><div align="center" class="style8">Order Date </div></td> 
    <td width="198" bgcolor="#333333"><div align="center" class="style1 style8">Confirmation</div></td>
    </tr>
   <?php
...
echo"<tr>
	...
	<td><input type='submit' value='Order Confirmation.' name='dd' class='btn btn-default'></td>
	</tr>";
