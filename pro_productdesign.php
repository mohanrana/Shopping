...
echo $query="insert into `outline`.`tbl_product`(`pd_name`,`pd_description`,`pd_price`,`pd_qty`,`pd_image`,`cat_id`) values('$Product','$Description','$Price','$QtyInStock','$Image','$Category')";
mysql_query($query);
